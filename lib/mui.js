...
(function(w) {
	...
	w.fui = fui;
	w.apppro = false; //生产环境
	w.imgpath = w.apppro ? 'http://itzx.price51.com/' : 'http://school.price51.com';
	w.imgpath2 = w.apppro ? 'http://itzx.price51.com/' : 'http://school.price51.com/';
	w.apiurl = w.apppro ? 'http://itzx.price51.com/SHSS1' : 'http://school.price51.com/wisdomc';
})(window);
//扩展mui.showLoading  
(function($, window) {  
    //显示加载框  
